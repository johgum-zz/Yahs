...
struct gyro_reg_s {
#if defined ARDUINO && defined MPU6050
	gyro_reg_s()
	{
		who_am_i       = 0x75;
		rate_div       = 0x19;
...
#if defined ARDUINO
static struct gyro_reg_s reg_tmp;
static struct hw_s hw_tmp;
static struct test_s test_tmp;
#endif
...
#if defined MPU6050 && !defined ARDUINO
const struct gyro_reg_s reg = {
    .who_am_i       = 0x75,
    .rate_div       = 0x19,
    .lpf            = 0x1A,
